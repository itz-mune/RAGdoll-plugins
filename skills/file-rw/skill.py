...
class FileRWTool(BaseTool):
    ...
    description: str = (
        ...
        "IMAGES: when creating a rich document (.docx/.pdf/.html), proactively call the "
        "search_images tool first to find relevant freely-licensed images, then embed the "
        "returned URLs using Markdown image syntax: ![caption](url) at natural points in "
        "the content (e.g. after a section heading). Call search_images once per major "
        "section or topic that would benefit from a visual. "
